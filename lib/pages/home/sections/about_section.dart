...
//                     Row(
//                       children: [
//                         // _AboutHighlight(icon: Icons.code, label: "Fresher"),
//                         // SizedBox(width: 30),
//                         // _AboutHighlight(
...
// }
//
// /// Small info boxes under "fast facts".
// class _AboutHighlight extends StatelessWidget {
//   final IconData icon;
//   final String label;
//
//   const _AboutHighlight({required this.icon, required this.label});
//
//   @override
//   Widget build(BuildContext context) {
//     return Row(
//       children: [
//         Icon(icon, color: Color(0xFF4D0202), size: 24),
//         SizedBox(width: 8),
//         Text(
//           label,
//           style: TextStyle(
