...
//         final double descSize = isMobile ? 11 : (isTablet ? 18 : 18);
...
//               minHeight: 120, // Minimum height only
//               // NO maxHeight - unlimited height
//             ),
...
//
//                         /// Flexible title section - Can wrap to multiple lines
//                         Expanded(
//                           child: Text(
//                             project.name,
...
//
//                   /// Description - NO HEIGHT LIMITS, wraps naturally
...
//                         // NO maxLines - let description expand naturally
//                       ),
//                     ),
//
            ...
            return Transform.scale(
              ...
              child: MouseRegion(
                ...
                child: GestureDetector(
                  onTap:
                      widget.onTap ??
                      () => Contents.launch(widget.project.codeUrl),
                  child: Container(
                    decoration: BoxDecoration(
